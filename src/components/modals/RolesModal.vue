<template>
  ...
  >
    <h3>Vyber postavy pro {{ nonTravelers }} hráčů:</h3>
    ...
    <div class="warning" v-if="hasSelectedSetupRoles">
      ...
      <span>
        Pozor: Ve hře jsou postavy, které mění přípravu hry. Randomizér
        nepočítá s těmito postavami.
      </span>
    </div>
    ...
    <div class="button-group">
      ...
      >
        ...
        Přiřaď {{ selectedRoles }} postav náhodně
      </div>
